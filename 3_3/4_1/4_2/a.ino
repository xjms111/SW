...
// Piny enkoderów
#define INTINPUT0 A0   // prawy enkoder
#define INTINPUT1 A1   // lewy enkoder
...
void setup() {
  ...
  Serial.println("f - goForward(10 cm)");
  Serial.println("b - goBack(10 cm)");
}
