...
void Wheels::back()
{
    // Uruchomienie beepera przy jeździe wstecz.
    // Im większa prędkość, tym krótszy okres.
    // W tej wersji używamy stałej prędkości 100.
...
void Wheels::stop()
{
    ...
    // Wyłączenie beepera po zatrzymaniu.
    stopBeep();
}
